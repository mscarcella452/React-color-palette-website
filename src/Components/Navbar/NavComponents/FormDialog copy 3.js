...
function AccountDialog({ variant, showIcon = false }) {
  ...
  const [formVariant, setFormVaraint] = useState(variant);
  ...
  //   if (formVariant !== null) {
  //     setFormOpen(false);
  //     formVariant !== initialFormVariant && setFormVaraint(variant);
  //   }
  // };
        ...
        {true ? (
          <>
            ...
            >
              ...
              <Box
                className='flexRow'
                sx={{ width: 1, flexWrap: "wrap", display: "none" }}
              >
...
const btnData = {
  "Sign Up": { btnVariant: "primary" },

  "Log In": { btnVariant: "secondary" },
};
